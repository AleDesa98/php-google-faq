<?php
    $faqs = [
        ...
        [
            ...
            <ol> <li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li> <br>
    ...
    foreach ($faqs as $faq) {
        echo "<h1>" . $faq["domanda"] . "</h1>";
        echo $faq["risposta"] . "<hr>";
    }
?>
